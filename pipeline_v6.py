...
_LLM_SYSTEM = (
    ...
    "10 dimensions. Return ONLY a valid JSON object — no markdown, no commentary."
)
...
_LLM_DIMENSIONS = {
    ...
    # v6 additions — strongest new signals from v5 ablation (r=+0.177, r=+0.167 vs video mem)
